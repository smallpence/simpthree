...
{
	/// <summary>
	/// Tool for drawing a line between two points
	/// </summary>
	public class LineTool : IShapeTool
	{
		public LineTool(string name, string description, Workspace myWorkspace, System.Drawing.Image icon) : base (name,description,myWorkspace,icon)
		{
		}
		
		internal override void ResolvePoints() {
			// do nothing
			// this stops points being resolved, stopping the IShapeTool implementation
		}
