...
namespace SIMP {
	public static class SimpConstants {
		...
		public static int WINDOWS_TOP_BAR_HEIGHT;    // different depending on OS
		public static int WINDOWS_BOTTOM_BAR_HEIGHT; // generated at runtime
		...
		public static int WORKSPACE_TOP_PADDING = 49;
		...
		public static int PROPERTY_HEIGHT; // the sum of the previous 4 properties
